...
COPY --from=deps /app/apps/notification/node_modules ./apps/notification/node_modules
...
RUN pnpm --filter @sherlock/notification build
...
COPY --from=builder /app/apps/notification/node_modules ./node_modules
COPY --from=builder /app/apps/notification/package.json ./
